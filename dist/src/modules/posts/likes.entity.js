...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.reaction),
    __metadata("design:type", user_entity_1.User)
], Reaction.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => post_entity_1.Post, (post) => post.reaction, { eager: true }),
    __metadata("design:type", post_entity_1.Post)
], Reaction.prototype, "post", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: "enum", enum: enum_roles_1.ReactionType, default: enum_roles_1.ReactionType.BENEFITED, nullable: true }),
